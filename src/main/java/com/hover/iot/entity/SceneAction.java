...
/**
 * An entity class that represents a scene action.
 */
@Entity
@Table(name = "TBL_SCENE_ACTION")
public class SceneAction {
    ...
    @Id
    @SequenceGenerator(
            name = "TBL_SCENE_ACTION_ID_SEQ",
            sequenceName = "TBL_SCENE_ACTION_ID_SEQ",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "TBL_SCENE_ACTION_ID_SEQ"
    )
    private String id;
     ...
     */
    @ElementCollection
    @CollectionTable(name = "TBL_SCENE_ACTION_PARAM", joinColumns = @JoinColumn(name = "action_id"))
